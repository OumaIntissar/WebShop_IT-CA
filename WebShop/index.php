...
<!-- most viwed  START -->
<div class="reviews" style="margin-top: -160px!important;">
	<div class="container" style="background-color: #D3F2F7">
        <div class="row">
            <div class="col-md-9">
                <h3>Most Viwed</h3>
            </div>
            ...
            <div class="carousel-inner">
                <div class="item active">
                    ...
                    <div class="row">
                            <?php
                            // output data of each row
                            while($row = $result_products_most_viwed->fetch_assoc()) { 
                            	$id_product    = $row["id_prod"]; 
                            	$name_product  =  $row["label_prod"];  
                            	$price_product = $row["price_prod"];  
                            	$image_product = $row['image_prod']  
                        ...
                        <div class="col-sm-3 text-center">
	                            <div class="col-item">
	                                ...
	                                <div class="photo">
		                                	<a href="product.php?id_product=<?php echo $id_product ?>" 
		                                		style="margin-right: -100px!important;">
		                                		<img style="background-color: white" src="<?php echo $image_product?>"  class="img-responsive" alt="image of product">
		                                	</a>
	                                </div>
	                                <div class="col-sm-2 col-ofsset-sm-1 info">
	                                    <div class="separator clear-left btn_cart_detail">
